...
export default function Featured() {
  return (
    <div id="featured-section" className="flex flex-col lg:flex-row lg:justify-between lg:items-center min-h-screen px-6 py-12 lg:py-0 bg-white">
      ...
      <div className="flex-1 text-left lg:h-[800px] flex flex-col justify-center lg:mr-12 lg:order-1">
        <h3 className="uppercase mb-6 text-3xl md:text-4xl lg:text-5xl font-bold text-black">ABOUT US</h3>
        <p className="text-base lg:text-lg mb-4 text-black">
        ...
        <p className="text-base lg:text-lg mb-8 text-black">
        ...
        <button className="bg-black text-white border-2 border-black px-6 py-3 text-sm font-semibold tracking-wider transition-all duration-300 hover:bg-white hover:text-black hover:border-black hover:scale-105 hover:shadow-xl cursor-pointer w-fit">
          LEARN MORE
        </button>
      </div>
    </div>
